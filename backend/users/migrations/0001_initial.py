    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attach_document', models.FileField(blank=True, null=True, upload_to='attach')),
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='commom.address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('ADMIN', 'admin'), ('DOCTOR', 'doctor'), ('PATIENT', 'patient'), ('RECEPTIONIST', 'receptionist')], max_length=20)),
