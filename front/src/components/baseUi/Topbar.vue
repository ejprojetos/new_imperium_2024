<template>
	...
	<div v-if="!isMobile" class="flex items-center justify-end h-12 px-4 bg-white">
		...
		<RouterLink :to="{ name: 'perfil_medico' }" class="">
			<div @click="goToProfile" class="flex items-center cursor-pointer gap-x-4">
				<img src="../../assets/placeholder.png" class="w-10 h-10 rounded-full" alt="" sizes="" srcset="" />
	...
	<!-- Mobile -->
	<div v-else class="flex items-center justify-between h-12 px-4 bg-white border-b border-gray-200">
