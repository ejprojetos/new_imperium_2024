<template>
	<LayoutDashboard>
		...
		<div class="px-12 mt-8">
			<div v-if="appointmentStore.loading" class="text-center">
				Carregando consultas...
			</div>
			<div v-else-if="appointmentStore.error" class="text-center text-red-600">
				{{ appointmentStore.error }}
			</div>
			<div v-else v-for="appointment in appointmentStore.appointments" :key="appointment.uuid"
...
// inicializa o store de consultas
const appointmentStore = useAppointmentStore()

// busca as consultas quando o componente é montado
onMounted(async () => {
