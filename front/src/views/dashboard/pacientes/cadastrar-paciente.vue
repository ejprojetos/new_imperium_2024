			...
			<div class="rounded-xl sm:rounded-none pb-[70px] pt-[29px] sm:pt-[40px] px-[20px] sm:px-[60px] mb-4 bg-white ded-lgroun gap-x-4 sm:w-[650px]"
				...
				<form @submit.prevent="submitForm">
					...
					<div class="grid grid-cols-1 gap-4">
						...
						<div class="sm:flex flex-coll gap-[80px]">
							<div>
								...
								<div v-if="formErrors.dateOfBirth" class="mt-1 text-sm text-red-500">
					...
					<div>
						...
						<input v-model="FormData.zip_code" type="text" class="px-2 py-1 rounded-2xl border w-260"
					...
					<div>
						...
						<input v-model="FormData.password" type="password"
							class="w-[250px] px-2 py-1 border rounded-2xl" placeholder="Digite sua senha" />
