                ...
                <form @submit.prevent="submitForm">
                    ...
                    <div class="mt-[20px]">
                        ...
                        <div class="flex items-start flex-col">
                            <label for="file-upload" class="px-4 py-2 bg-white text-black rounded-full sm:rounded-lg border border-gray-300 cursor-pointer text-lg hover:bg-gray-100">Anexar</label>
                            <input 
                            @change="onFileChange"
                            type="file"
                            id="file-upload"
                    ...
                    <div class="modal-box w-[310px] sm:w-[750px] max-w-5xl">
                        <div>
                            <h1 class="font-montserrat text-[1.375rem] font-semibold text-center">Médico cadastrado com sucesso!</h1>
                        </div>
