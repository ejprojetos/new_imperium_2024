				...
				<form @submit.prevent="submitForm">
					...
					<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
						<div>
							...
							<input v-model="formData.clinicName" type="text" class="w-full px-2 py-1 border rounded" />
						</div>
						<div>
						...
						<div>
							...
							<input v-model="formData.cnpj" type="text" class="w-full px-2 py-1 border rounded" />
						</div>
					</div>
					...
					<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
						<div>
							...
							<input v-model="formData.country" type="text" class="w-full px-2 py-1 border rounded" />
						</div>
						<div>
							<label class="block mb-1">Estado:</label>
							<input v-model="formData.state" type="text" class="w-full px-2 py-1 border rounded" />
						</div>
						<div>
							<label class="block mb-1">Cidade:</label>
							<input v-model="formData.city" type="text" class="w-full px-2 py-1 border rounded" />
						</div>
						<div>
						...
						<div>
							...
							<input v-model="formData.zipCode" type="text" class="w-full px-2 py-1 border rounded" />
						</div>
						<div>
							<label class="block mb-1">Logradouro:</label>
							<input v-model="formData.street" type="text" class="w-full px-2 py-1 border rounded" />
						</div>
						<div>
							<label class="block mb-1">Número:</label>
							<input v-model="formData.number" type="text" class="w-full px-2 py-1 border rounded" />
						</div>
					</div>
					...
					<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
						<div>
							...
							<input v-model="formData.email" type="email" class="w-full px-2 py-1 border rounded" />
						</div>
						<div>
							<label class="block mb-1">Celular:</label>
							<input v-model="formData.phone" type="tel" class="w-full px-2 py-1 border rounded" />
						</div>
					</div>
...
const formatClinicData = (): Clinic => {
	return {
		name: formData.clinicName, // nome da clínica
		nome_responsavel: formData.clinicName,
		cnpj: formData.cnpj,
